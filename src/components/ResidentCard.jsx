    ...
    <article className="resident">
      ...
      <section className="resident__body">
          ...
          <ul className="resident__list">
              ...
              <li className="resident__item"><span className="resident__label">Episodes where appear</span><span className="resident__item-value">{character.episode?.length}</span></li>
          </ul>
      </section>
    </article>
  )
